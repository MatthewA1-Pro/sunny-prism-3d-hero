...
export const heroContent = {
  ...
  // Bottom rail of the design grid: direction arrows and a slide counter.
  rail: {
    arrows: ['ne', 'ne', 'n', 'nw', 'nw'],
    counter: '1 / 1',
  },
}
...
export const unresolvedContent = [
  ...
  'Bottom-rail and panel logos: the design shows third-party tech logos (Docker, Laravel). Neutral line icons hold those cells until Sunny confirms which marks, if any, belong there.',
